# Catalog integrity audit — montitrentini — 2026-09-17

Sources checked: item store (live items-get.js), image manifest (src/data/montitrentini/images.json), pricing (src/data/montitrentini/catalog.json).

**124 items · 319 images (58 distinct codes) · 107 priced SKUs.**
...
## High (68) — buyer-visible or data-loss risk
...
- No photo linked for item "20569" — "Bianco D'Italia 1/4 Wheel".
...
- No photo linked for item "40086" — "Montasio PDO".
...
- No photo linked for item "01174" — "Smoked Provolone".
...
- No photo linked for item "05091" — "Grana Padano".
...
- No photo linked for item "05600" — "Parmigiano".
...
## Medium (2) — inconsistent, worth a look
...
## Info (19) — asymmetries that may be intentional
...
- Item "04108" has a record but isn't on the price list (catalog.json) — may be intentional (discontinued, sample-only, etc.).
