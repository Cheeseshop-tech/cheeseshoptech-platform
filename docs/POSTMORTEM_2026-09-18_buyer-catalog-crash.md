...
| Check the Sentry dashboard (sentry.io) for this crash and confirm what it recorded | Rick | P0 | **Open** — needs sentry.io account access this session doesn't have |
| Add a Sentry alert rule (email/Slack) for new production issues | Rick | P0 | **Open** — same access constraint |
