#!/bin/bash
# Double-click this file to push the "Priority — response needed" live-data feature.
# You don't need to type anything — this window will do it and tell you when it's done.
cd "$(dirname "$0")" || exit 1

echo "Pushing 2 commits to GitHub (this is what makes Netlify deploy the change)…"
echo
