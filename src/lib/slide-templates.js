...
export const SLIDE_TEMPLATES = [
  ...
  { id: "cover/v5", label: "Cover — Casa Finco", tag: "warm card", family: "cover",
    ...
    slots: [
      ...
      { id: "kicker_pill", role: "lock", kind: "shape", x: 60, y: 70, w: 240, h: 44, z: 4, fill: "$primary", radius: 999 },
      { id: "topic_label", role: "var", kind: "text", x: 60, y: 70, w: 240, h: 44, z: 5, fit: "shrink", vcenter: true,
        font: { font: "$ui", size: 12, uppercase: true, bold: true, color: "$cream", align: "center" }, label: "Kicker" },
      { id: "slide_title", role: "var", as: "title", kind: "text", x: 60, y: 150, w: 400, h: 180, z: 5, fit: "shrink",
  ...
  { id: "cover/v6", label: "Cover — Vetta", tag: "bold graphic", family: "cover",
    ...
    slots: [
      ...
      { id: "ribbon", role: "lock", kind: "shape", x: 0, y: 72, w: 300, h: 44, z: 4, fill: "$accent" },
      { id: "topic_label", role: "var", kind: "text", x: 24, y: 72, w: 260, h: 44, z: 5, fit: "shrink", vcenter: true,
        font: { font: "$ui", size: 12, uppercase: true, bold: true, color: "$cream", align: "left" }, label: "Kicker" },
      { id: "slide_title", role: "var", as: "title", kind: "text", x: 40, y: 150, w: 420, h: 260, z: 5, fit: "shrink",
  ...
  { id: "product-feature/v4", label: "Product Feature — Alta Quota", tag: "restrained editorial", family: "product-feature",
    ...
    slots: [
      ...
      { id: "rule_line", role: "lock", kind: "shape", x: 40, y: 56, w: 40, h: 2, z: 5, fill: "$primary" },
      ACCENT_BAR,
      { id: "topic_label", role: "var", kind: "text", x: 40, y: 68, w: 340, h: 32, z: 5, fit: "shrink",
        font: { font: "$ui", size: 12, uppercase: true, bold: true, color: "$primary", align: "left" }, label: "Topic" },
      { id: "slide_title", role: "var", as: "title", kind: "text", x: 40, y: 106, w: 340, h: 90, z: 5, fit: "shrink",
        font: { font: "$display", size: 26, italic: true, color: "$ink", align: "left" }, label: "Title" },
      { id: "story_block", role: "var", as: "story", kind: "text", x: 40, y: 206, w: 340, h: 230, z: 5, fit: "shrink",
        parts: [
          { id: "headline", font: { font: "$ui", size: 12, uppercase: true, bold: true, color: "$accent", align: "left" } },
  ...
  { id: "closing/v4", label: "Closing — Vetta", tag: "bold graphic", family: "closing",
    ...
    slots: [
      ...
      { id: "slide_title", role: "var", as: "title", kind: "text", x: 80, y: 180, w: 800, h: 140, z: 5, fit: "shrink",
