...
- **Brand — official green + terracotta signature.** Whole platform Forest Green `#064E22` (house + Monti). Terracotta `#9A3B1B` kept as the house wordmark/favicon signature (DESIGN_SYSTEM A2/A5).
